...
class ShareQrTablePage extends StatefulWidget {
  ...
  @override
  State<ShareQrTablePage> createState() => _ShareQrTablePageState();
}

class _ShareQrTablePageState extends State<ShareQrTablePage> {
  ...
  void _addPhoneNumberField() {
    int maxAddition =
        widget.selectedSeats - (widget.sharedWithIds?.length ?? 0);
